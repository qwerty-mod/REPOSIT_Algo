...
namespace Lab6__3
{
    internal class Program
    {
        ...
        {
            // Задание 3. Дан массив m*n определить положение элементов минимакса (мин в строке и макс в столбце / макс в строке и мин в столбце) сортировать элементы в строках нельзя.
